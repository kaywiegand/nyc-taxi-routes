...
kernel: ## Jupyter Kernel registrieren
	. .venv/bin/activate && python -m ipykernel install --user --name nyc_taxi_routes --display-name "Python (nyc_taxi_routes)"
	@echo "✅ Kernel 'nyc_taxi_routes' registriert."
