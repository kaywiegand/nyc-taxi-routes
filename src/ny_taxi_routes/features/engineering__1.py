...
def add_time_features(df):
    ...
    # Definition der Time-Slots
    bins = [0, 6, 11, 16, 20, 24]
    labels = ['Night', 'Morning Rush', 'Midday', 'Evening Rush', 'Night']
    # 'Night' doppelt am Anfang und Ende, um 20-24 und 0-6 abzudecken
    df['time_slot'] = pd.cut(df['pickup_hour'], bins=bins, labels=labels, include_lowest=True, ordered=False)
